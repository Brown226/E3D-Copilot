...
>(({ className, ...props }, ref) => (
	<TabsPrimitive.List
		ref={ref}
		className={cn(
			"inline-flex h-8 items-center justify-start border-b border-editor-group-border bg-transparent px-0 text-muted-foreground",
			className,
		)}
		{...props}
	/>
